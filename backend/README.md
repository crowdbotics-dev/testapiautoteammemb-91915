...
## Project Structure
    ...
    ├── testapiautoteammemb_91915  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_91915`
...
2. Clone this repo and `cd testapiautoteammemb_91915`
